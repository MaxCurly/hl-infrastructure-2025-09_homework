...
На вложенном скриншоте отражена работа веб-приложения:

homework-4.png: дефолтная страница wordpress (работоспособность проверялась после отключения серверов lb01 (балансировщик) и node1 (gfs2 + один из экземпляров wordpress))