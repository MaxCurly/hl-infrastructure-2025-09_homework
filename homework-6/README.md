Домашнее задание по теме "PostgreSQL cluster // ДЗ"
...
homework-6-1.png: статус patroni кластера c db01, подключение к postgres через vip haproxy, выключение db01 (он же lb01)

homework-6-2.png: статус patroni кластера c db02 после отключения db01, подключение к postgres через vip haproxy